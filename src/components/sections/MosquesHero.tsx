...
import { useInitiativeContact } from '@/components/ui/InitiativeContactModal';

import { EASE_OUT, fadeUp, staggerContainer } from '@/lib/motion';

export function MosquesHero() {
  ...
  return (
    ...
    >
      ...
      >
        <Image
          alt="A completed Bait ul Aqba temporary tent mosque in Gaza"
          className="object-cover object-center lg:object-right"
          fill
          priority
          sizes="100vw"
          src="/images/official/bait-ul-aqba/tent-mosque-exterior.png"
        />
      ...
      <div className="relative z-10 mx-auto grid w-full max-w-7xl items-end gap-10 px-5 pb-20 sm:px-8 lg:grid-cols-12 lg:px-12 lg:pb-24">
        ...
        >
          ...
          <motion.p
            ...
            variants={fadeUp}
          >
            In Gaza, we are establishing temporary mosques — safe places for worship, Qur’an
            learning, community, and hope.
          </motion.p>

          <motion.div className="mt-8 flex flex-wrap gap-3" variants={fadeUp}>
            <Button onClick={() => openInitiativeContact('mosque')} size="lg">
